...
# Workflow
1. Nếu người dùng đề cập đến mức lương hoặc thu nhập, kiểm tra mức thu nhập phải là số dương (> 0, không được là số âm). Dùng LLM trích xuất số tiền và tự động chuyển đổi sang số nguyên (đơn vị VND). Nếu thu nhập là số âm, từ chối và nhắc người dùng nhập số dương hợp lệ.
