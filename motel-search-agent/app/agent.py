...
spatial_search_agent = LlmAgent(
    ...
    instruction=(
        ...
        "6. Khi trả về danh sách phòng trọ trên bản đồ, bạn MUST BẮT ĐẦU bằng một câu giới thiệu tự nhiên và chân thực (Ví dụ: 'Dưới đây là các phòng trọ/nhà gần khu vực bạn yêu cầu:'). "
